...
export const BENEFITS = [
  ...
  },
  {
    no: 2,
    icon: '🧸',
    title: '영역별 프로그램 기획자동화',
    body: '영역별로 프로그램을 자동으로 기획해 주는 도우미입니다.',
    color: '#3b82f6',
    // 아래 버튼들은 관리자 화면 「기본 설정」에서 넣고 뺀다 (site.planLinks)
    links: 'planLinks',
  },
  {
    no: 3,
    icon: '🗂️',
    title: '프로그램 기획 자동화',
    body: '우리원 연령별 다양한 주제를 담은 프로그램 연간자동화',
    color: '#ef4444',
  ...
  },
  {
    ...
    color: '#8b5cf6',
    // 아래 버튼들은 관리자 화면 「기본 설정」에서 넣고 뺀다 (site.siteLinks)
    links: 'siteLinks',
  },
];
